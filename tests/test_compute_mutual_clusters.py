...
class TestComputeMutualClusters(unittest.TestCase):
    """
    Test functionality of mutual_clusters.compute_mutual_clusters()
    ------------
    Example
    ------------
    >>> python3 -m unittest -v tests.test_compute_mutual_clusters
    """

    def test_on_empty(self):
        """
        compute_mutual_clusters returns a dictionary
        """
        _a = pd.DataFrame()
        ...
        self.assertIsInstance(
            _res0,
            dict,
            f"""compute_mutual_clusters should return a dictionary, but returned {type(_res0)}""",
        )
        self.assertEqual(
            _res0,
            dict(),
    ...
    def test_on_one_layer(self):
        """
        compute_mutual_clusters returns a dictionary, and returns all the nodes
        """
